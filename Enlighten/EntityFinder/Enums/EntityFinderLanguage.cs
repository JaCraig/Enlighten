...
namespace Enlighten.NameFinder.Enums
{
    ...
    public class EntityFinderLanguage : StringEnumBaseClass<EntityFinderLanguage>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EntityFinderLanguage"/> class.
        /// </summary>
        /// <param name="name">The name.</param>
        public EntityFinderLanguage(string name)
            : base(name)
        {
        }
        ...
        /// Initializes a new instance of the <see cref="EntityFinderLanguage"/> class.
        /// </summary>
        public EntityFinderLanguage() : base(string.Empty)
        {
        }
