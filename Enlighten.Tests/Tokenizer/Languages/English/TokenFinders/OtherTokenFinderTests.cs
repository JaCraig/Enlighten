...
{
    public class OtherTokenFinderTests : TestBaseClass<OtherTokenFinder>
    {
        ...
        {
            var Result = new OtherTokenFinder().IsMatch(new TokenizableStream<char>(input?.ToCharArray() ?? Array.Empty<char>()));
