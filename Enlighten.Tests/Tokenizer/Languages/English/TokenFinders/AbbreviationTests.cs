...
{
    public class AbbreviationTests : TestBaseClass<Abbreviation>
    {
        public static TheoryData<string, Token> Data = new TheoryData<string, Token>
        {
            { "This has no ellipsis",null },
            { "Mr. ... This has ellipsis",new Token(2,0,TokenType.Abbreviation,"Mr.") },
            { "This has no ellipsis..",null },
            { "This. has. no. ellipsis.",null },
            { ".This. has. no. ellipsis.",null },
            { "..This. has. no. ellipsis.",null },
            { "O.K. . . . . . . .This has an ellipsis.",new Token(3,0,TokenType.Abbreviation,"O.K.") },
            { "Dr Strange is kind of cool... This has an ellipsis.",new Token(1,0,TokenType.Abbreviation,"Dr") },
            {"appt… This has an ellipsis. My appt is in the morning",new Token(3,0,TokenType.Abbreviation,"appt" ) },
            {"IBM… This has an ellipsis. My appt is in the morning",new Token(2,0,TokenType.Abbreviation,"IBM" ) },
            { " ... This has no ellipsis.",null },
